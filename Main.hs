...
-- data Expression = Var String | BinOp (Bool -> Bool -> Bool) Expression Expression

----- TOKENIZER -----
data Token = ParenOpen | ParenClose | And | Or | Not | Implies | Iff | Var String deriving (Show, Eq)
